...
const navItems = [
  ...
  { path: '/app/assistente', icon: 'ti-robot', label: 'Assistente' },
  { path: '/app/planos', icon: 'ti-crown', label: 'Planos' },
]

const bottomNavItems = [
  { path: '/app/dashboard', icon: 'ti-layout-dashboard', label: 'Início' },
  { path: '/app/fazendas', icon: 'ti-map', label: 'Fazendas' },
  { path: '/app/sensores', icon: 'ti-activity', label: 'Sensores' },
  { path: '/app/alertas', icon: 'ti-bell', label: 'Alertas' },
  { path: '/app/assistente', icon: 'ti-robot', label: 'IA' },
]
...
/* BOTTOM NAV */
.bottom-nav { display: none; position: fixed; bottom: 0; left: 0; right: 0; background: var(--surface); border-top: 1px solid var(--border); z-index: 40; padding: 0.5rem 0 calc(0.5rem + env(safe-area-inset-bottom)); }
...
.bottom-nav-item.active .ti { color: var(--green); }
